...
const Muser = () => {
    ...
    const memberData = useSelector((store) => store.memberReducer);
    ...
    const handlePageNext = () => {
        if (queryParams.page < memberData.totalPages) {
            const newPage = queryParams.page + 1;
            setQueryParams({ ...queryParams, page: newPage });
        }
    };
    ...
    return (
        <>
            <div className='grid justify-items-center'>
                <div className='lg:w-[950] md:w-[95%] overflow-x-auto '>
                    <div className="rounded-none bg-transparent">
                        <div className='lg:w-[950] md:w-[95%] grid grid-flow-col bg-transparent'>
                            <div className='mt-10 mb-5 mx-5 flex items-end'>
                                <div className='text-3xl text-gray-900 font-bold mr-5'><span>ユーザー管理</span></div>
                                <button
                                    className='btn-add'
                    ...
                    <UserTable />
                    <div className="flex items-center justify-between border-t border-blue-gray-50 p-4 w-full min-w-[1280px]">
                        <div>
                            {queryParams.page } / {memberData.totalPages}
                        </div>
